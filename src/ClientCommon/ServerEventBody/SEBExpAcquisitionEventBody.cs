...
{
	public class SEBExpAcquisitionEventBody : SEBServerEventBody
	{
		public override void Serialize(PacketWriter writer)
		{
			base.Serialize(writer);
			writer.Write(this.acquiredExp);
		...
		public override void Deserialize(PacketReader reader)
		{
			...
			this.acquiredExp = reader.ReadInt64();
		...
		public SEBExpAcquisitionEventBody()
		{
		}
