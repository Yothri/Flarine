...
{
	public class JobBattlefieldInfoResponseBody : ResponseBody
	{
		...
		public override void Deserialize(PacketReader reader)
		{
			...
			this.myBestRecord = reader.ReadPDPacketData<PDJobBattlefieldBestRecord>();
			this.bestRecord = reader.ReadPDPacketData<PDJobBattlefieldBestRecord>();
		}

		public JobBattlefieldInfoResponseBody()
		{
		}
		...
		public PDJobBattlefieldBestRecord myBestRecord;

		public PDJobBattlefieldBestRecord bestRecord;
	}
}
