...
{
	public class SEBGuildBattlefieldCompletedEventBody : SEBServerEventBody
	{
		public override void Serialize(PacketWriter writer)
		{
			base.Serialize(writer);
			writer.Write(this.winnerGuildId);
			writer.Write(this.winnerGuildName);
		...
		public override void Deserialize(PacketReader reader)
		{
			...
			this.winnerGuildId = reader.ReadGuid();
			this.winnerGuildName = reader.ReadString();
		...
		public SEBGuildBattlefieldCompletedEventBody()
		{
		}

		public Guid winnerGuildId;

		public string winnerGuildName;
