...
{
	public class SEBArenaVictoryEventBody : SEBServerEventBody
	{
		public override void Serialize(PacketWriter writer)
		{
			...
			writer.Write(this.winnerBuffRemainingTime);
		}
		...
		public override void Deserialize(PacketReader reader)
		{
			...
			this.winnerBuffRemainingTime = reader.ReadSingle();
		}

		public SEBArenaVictoryEventBody()
		{
		}
		...
		public float winnerBuffRemainingTime;
	}
}
